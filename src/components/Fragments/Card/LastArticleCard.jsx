...
export const LastArticleCard = ({ image, title, readmore, classname }) => {
  return (
    <div className={`${classname} mb-6`} >
      ...
      <h2 className="font-utama text-xs font-medium sm:text-xl pb-2 border-b border-black max-w-20 sm:max-w-32 md:text-2xl md:max-w-36 lg:text-sm lg:max-w-24">{readmore}</h2>
    </div>
  );
};
